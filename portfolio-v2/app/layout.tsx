...
export const metadata: Metadata = {
  ...
  keywords: ["Mohit Agarwal", "portfolio", "B.Tech IT", "entrepreneur", "strategy consulting", "fintech"],
  authors: [{ name: "Mohit Agarwal" }],
  openGraph: {
    title: "Mohit Agarwal — Business × Tech 🐉",
    description: "B.Tech IT student. Aspiring entrepreneur. Dragon enthusiast.",
    type: "website",
  },
};
